...
<body>
    ...
    <div class="container mt-4" style="max-width:680px;">
        <div class="card text-center mb-4">
            <div class="card-body">
                <img src="/uploads/<?= htmlspecialchars($user['profile_image'] ?? 'default.png') ?>" alt="Profile"
            ...
            <?php foreach ($posts as $post): ?>
                <div class="card mb-3">
                    <div class="card-body d-flex">
                        <img src="/uploads/<?= htmlspecialchars($user['profile_image'] ?? 'default.png') ?>" alt="Profile"
                            class="rounded-circle me-2 flex-shrink-0" width="40" height="40" style="object-fit:cover;">
                        <div>
